...
public class BookCommands {
    ...
    public void outputTheSelectedBook() {
        bookService.getByIsbn(commonShell.getCurrBook());
    }
    ...
    public void deleteBookByIsbn() {
        bookService.deleteByIsbn(commonShell.getCurrBook());
    ...
    public void addGenreToBook(@ShellOption String genreName) {
        bookService.addGenreToBook(commonShell.getCurrBook(), genreName);
    }
    ...
    public void addAuthorToBook(@ShellOption String fullName) {
        bookService.addAuthorToBook(commonShell.getCurrBook(), fullName);
    }
